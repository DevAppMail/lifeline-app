...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setGoogleLoading(false);
      setInputError("Unable to connect to Google. Please try another method.");
    }
  };
            ...
            {step === "input" && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full h-12 rounded-xl text-sm font-semibold flex items-center justify-center gap-3 bg-white dark:bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-100 transition-colors shadow-sm disabled:opacity-60"
                >
                ...
                {inputError && (
                  <p className="text-sm text-destructive font-medium bg-destructive/5 rounded-xl px-4 py-2.5">{inputError}</p>
                )}
